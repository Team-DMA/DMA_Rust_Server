...
CHANGELOG FOR UPDATE 1.3.1, NOVEMBER 21 2020
- Added height modifier (request)
...
USING:
If custom prefab was properly installed, just search for "Cobalt Office 1-3-1" in Prefabs List menu. Double click on it and it will be spawned on your map.
