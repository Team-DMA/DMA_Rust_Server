...
{
    [Info("Dynamic PVP", "CatMeat/Arainrr", "4.2.2", ResourceId = 2728)]
    ...
    public class DynamicPVP : RustPlugin
    {
        ...
        private void LockedCrateEvent(HackableLockedCrate hackableLockedCrate)
        {
            ...
            HandleGeneralEvent(GeneralEventType.HackableCrate, hackableLockedCrate, false);
        }
        ...
        private void SupplyDropEvent(SupplyDrop supplyDrop, bool isLanded)
        {
            ...
            if (isFromSupplySignal)
            {
                ...
                action?.Invoke();
                HandleGeneralEvent(GeneralEventType.SupplySignal, supplyDrop, isLanded);
            }
            else
            {
                ...
                HandleGeneralEvent(GeneralEventType.SupplyDrop, supplyDrop, isLanded);
            }
        }
        ...
        private bool HandleGeneralEvent(GeneralEventType generalEventType, BaseEntity baseEntity, bool useEntityID)
        {
            ...
            return CreateDynamicZone(eventName, position, useEntityID ? baseEntity.net.ID.ToString() : null);
        }
        ...
        private bool CreateDynamicZone(string eventName, Vector3 position, string zoneID = "", bool delay = true)
        {
            ...
            if (zoneAdded)
            {
                ...
                if (duration > 0f)
                {
                    ...
                    eventTimers.Add(zoneID, timer.Once(duration, () => DeleteDynamicZone(zoneID)));
                }
        ...
        {
			Puts("Debug, zoneID: " + zoneID + ", mapping: " + mapping);
